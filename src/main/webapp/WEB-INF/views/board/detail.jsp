...
<div class="container">
    ...
    <div>
        ...
        <br/>
        <%--<ul class="replies">
            <c:forEach var="reply" items="${board.replies}" varStatus="rootStatus">
                <li id="reply-${reply.id}" class="reply">
                    <div class="reply-wrapper">
                        <div class="card">
                            ...
                            <div class="card-footer bg-white p-2">
                                &lt;%&ndash;<button id="btn-nested-reply" type="button" class="btn btn-secondary btn-sm">Reply</button>&ndash;%&gt;
                                <div class="like cursor action-collapse">
                                    ...
                                    <small class="text-muted ml-2" style="vertical-align: middle">Last updated 3 mins ago</small > &lt;%&ndash;TODO: 업데이트된 시간{x mins ago, x days 7], x week, a year, ""}&ndash;%&gt;
                                </div>
                                ...
                                &lt;%&ndash; Collapsible &ndash;%&gt;
                                    <div id="collapse-${rootStatus.count}" class="bg-light p-2 collapse">
                                                ...
                                                <div class="bg-white n-reply">
                                                    <div class="d-flex flex-row user-info">
                                                        <span class="fs-16">${nestedReply.user.userId}</span>
                                                            &lt;%&ndash;<div class="d-flex flex-column justify-content-start ml-2"><span class="d-block font-weight-bold name">Marry Andrews</span><span class="date text-black-50">Shared publicly - Jan 2020</span></div>&ndash;%&gt;
                                                    </div>
                                                    <div class="mt-2 mx-2">
                                        ...
                                        <div class="d-flex flex-row align-items-start">
                                            <label>
                                                <textarea class="form-control ml-2 shadow-none textarea" id="nestedReplyContent-${reply.id}"></textarea>
                                            </label>
                                        </div>
